...
WHERE d.id IN (
  ...
  'da100001-0000-4000-8000-000000000001',
  'da100001-0000-4000-8000-000000000002',
  'da100001-0000-4000-8000-000000000003'
)
...
WHERE d.id IN (
  ...
  'da100001-0000-4000-8000-000000000004'
)
ON CONFLICT DO NOTHING;
...
WHERE d.id IN (
  ...
  'da100001-0000-4000-8000-000000000005'
)
ON CONFLICT DO NOTHING;
...
WHERE d.id IN (
  ...
  'da100001-0000-4000-8000-000000000006'
)
ON CONFLICT DO NOTHING;
...
WHERE d.id IN (
  ...
  'da100001-0000-4000-8000-000000000007'
)
ON CONFLICT DO NOTHING;
...
WHERE d.id IN (
  ...
  'd2000001-0000-4000-8000-000000000011',
  'da100001-0000-4000-8000-000000000008'
)
ON CONFLICT DO NOTHING;

-- Foundation DA docs use da100001-* (see 006 / 011). Expanded corpus uses d2000001-*.
